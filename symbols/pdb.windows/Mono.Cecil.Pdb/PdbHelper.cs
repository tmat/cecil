...
namespace Mono.Cecil.WindowsPdb {
	...
	public sealed class NativePdbReaderProvider : ISymbolReaderProvider {
		...
		public ISymbolReader GetSymbolReader (ModuleDefinition module, string fileName)
		{
			...
			return new Pdb.NativePdbReader (Disposable.Owned (File.OpenRead (Mixin.GetPdbFileName (fileName)) as Stream));
		}
		...
		public ISymbolReader GetSymbolReader (ModuleDefinition module, Stream symbolStream)
		{
			...
			return new Pdb.NativePdbReader (Disposable.NotOwned (symbolStream));
		}
	}
